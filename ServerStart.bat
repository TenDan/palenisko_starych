...
java -server -Xms512M -Xmx4096M -XX:PermSize=256M -jar FTBServer-1.7.10-1614.jar nogui
...
if exist autostart.stamp (
    ...
    java -server -Xms512M -Xmx4096M -XX:PermSize=256M -XX:+UseParNewGC -XX:+CMSIncrementalPacing -XX:+CMSClassUnloadingEnabled -XX:ParallelGCThreads=2 -XX:MinHeapFreeRatio=5 -XX:MaxHeapFreeRatio=10 -jar FTBServer-1.7.10-1614.jar nogui
